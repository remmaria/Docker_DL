...
# compartilhado -- scripts/04b_train_rrin.py (ver protocolo secao 14.5 item
# 2/secao 15) reusa a MESMA funcao em vez de duplicar a matematica. Nenhuma
# mudanca de comportamento aqui, so de localizacao do codigo.
